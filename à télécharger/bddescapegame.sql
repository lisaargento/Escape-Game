...
(2, 'Cadenas', 'Mince la porte de la salle est fermée ...\r\n<br>\r\nIl me semble que le code de ce cadenas est la date de la création de l’Académie du Climat de Paris ! Elle se situe Place Baudoyer à côté de l’hôtel de ville de Paris, ça te dis quelque chose ?', 48.841, 2.58736, 50, 50, 18, '../img/cadenas.png', 3, 3, 2021, 4, ''),
...
(9, 'Carte postale', '', 48.2766, -3.55418, 270, 210, 16, '../img/carte_postale.png', 2, NULL, NULL, 10, '../audio/crozon.M4A'),
