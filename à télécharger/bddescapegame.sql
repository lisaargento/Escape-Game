...
(3, 'Plaque', "Le saviez-vous?\r\nL'Académie du Climat c'est un lieu pour s'informer, se former, échanger et agir!\r\nElle regroupe les locaux de plusieurs associations engagées et accueille des ateliers, des conférences/débats, des projections, des expositions... mais aussi des classes et des groupes pour les accompagner de la sensibilisation à l'engagement.", 48.8563, 2.35584, 17, '../img/plaque.jpg', 1, NULL, NULL, NULL),
(4, 'Boite à outils', "Le saviez-vous?\r\nRéparer et revaloriser nos biens est très important car la production et l'incinérations sont les étapes les plus polluantes dans le cycle de vie des objets. En donnant une seconde vie à nos biens nous évitons d'en produire de nouveaux et nous réduisons nos déchets. ", 48.841, 2.58736, 18, '../img/outils.png', 2, NULL, NULL, NULL),
