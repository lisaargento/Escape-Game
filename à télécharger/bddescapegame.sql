...
--
-- Host: localhost:3306
-- Generation Time: Dec 03, 2022 at 11:22 AM
...
(1, 'Vélos cassés', 'Ohhh non ! Mon vélo a crevé ...\r\n<br>\r\nIl me semble que les ENSGagés ont mis à disposition des outils qui pourraient nous servir ;) ', 48.8415, 2.58786, 100, 100, 18, '../img/velos_casses.png', 4, 2, 4, 5, ''),
(2, 'Cadenas', 'Mince la porte de la salle est fermée ...\r\n<br>\r\nIl me semble que le code de ce cadenas est la date de la création de l’Académie du Climat de Paris ! Elle se situe Place Baudoyer à côté de l’hôtel de ville de Paris, ça te dis quelque chose ?', 48.841, 2.58736, 50, 50, 19, '../img/cadenas.png', 3, 3, 2021, 4, ''),
(3, 'Plaque', 'Le saviez-vous ?\r\n<br> <br>\r\nL\'Académie du Climat est un lieu pour s\'informer, se former, échanger et agir !\r\n<br>\r\nElle regroupe les locaux de plusieurs associations engagées et accueille des ateliers, des conférences/débats, des projections, des expositions... Mais aussi des classes et des groupes pour les accompagner de la sensibilisation à l\'engagement.', 48.8563, 2.35584, 250, 200, 17, '../img/plaque.jpg', 1, NULL, NULL, NULL, ''),
...
(5, 'Vélos réparés', '', 48.8415, 2.58786, 100, 100, 18, '../img/velos_repares.png', 2, NULL, NULL, 6, '../audio/depart.m4a'),
...
(7, 'Mont Saint Michel', 'Le saviez-vous ?\r\n<br><br>\r\nCet îlot rocheux consacré à saint Michel est une étape des Chemins de Saint-Jacques-de-Compostelle. Il figure, avec sa baie, sur la liste du patrimoine mondiale de l\'UNESCO depuis 1979. A l\'origine nommé Mont Tombe, il y fut érigé un oratoire en l\'honneur de l\'archange saint Michel en 708 qui lui donnera plus tard l\'appellation qu\'on lui connait aujourd\'hui.', 48.6358, -1.51194, 500, 400, 17, '../img/photo_mont.jpg', 1, 8, NULL, NULL, ''),
(8, 'Dinan', '', 48.4572, -2.03774, 250, 200, 15, '../img/photo_dinan.jpg', 1, NULL, NULL, NULL, ''),
(9, 'Carte postale', '', 48.2766, -3.55418, 250, 200, 16, '../img/carte_postale.png', 2, NULL, NULL, 10, '../audio/crozon.m4a'),
(10, 'maison de Malo', 'On peut passer voir Malo ! Il me semble qu\'il est à Concarneau en ce moment ...', 48.2139, -4.53925, 100, 100, 15, '../img/maison.png', 3, 11, 16, 12, ''),
(11, 'tete de Malo', '', 47.8555, -3.90607, 200, 200, 17, '../img/tete_malo.png', 1, NULL, NULL, NULL, ''),
